...
<head>
  ...
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/dist/css/custom.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/dist/css/skins/_all-skins.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{url('/')}}/bower_components/AdminLTE/plugins/daterangepicker/daterangepicker.css">
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-mini"><b>TA</b>XI</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Corover</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{(isset($userdata->image) && !empty($userdata->image)) ? url('/').'/images/users/'.$userdata->image : url('/').'/images/users/no_image.png'}}" class="user-image" alt="User Image">
    ...
    @include('layouts/superadmin_rightsidebar')
