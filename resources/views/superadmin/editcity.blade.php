      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
               {!! Form::open(['url' => 'edit-city']) !!}
               {!! Form::token() !!}

              <div class="box-body">
               <div class="form-group">
                  <label for="exampleInputEmail1">Country Name</label>
                  {!! Form::select('country_id',$countries,$admin->country_id,['class'=>'form-control']) !!}
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">City Code </label>
                  {!! Form::text('code',$admin->code,['class'=>'form-control','placeholder' => 'Code']) !!}
                </div>
              </div>
              <!-- /.box-body -->
