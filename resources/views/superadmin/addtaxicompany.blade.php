      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          {!! Form::open(['url' => 'add-taxi-company']) !!}
           {!! Form::token() !!}
                ...
                <div class="form-group">
                  ...
                  {!! Form::textarea('address',null,['class'=>'form-control','placeholder' => 'Last Name']) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Company Phone Number</label>
                   {!! Form::text('phone',null,['class' => 'form-control','placeholder' => 'Password']) !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Company Owner</label>
                   {{ Form::select('owner_id',$allusers, '', ['class' => 'form-control']) }}
                </div>
