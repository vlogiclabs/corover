            ...
            <table class="tablesaw table-striped table-hover table-bordered table tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="table-4226">
              <thead>
                <tr>
                  ...
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Email</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">phone</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Pending/Rejected</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Registered on</th>
                  ...
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">verified</th>
              ...
              @foreach($admins as $admin)
                <tr>
                  <td class="title"><a href="javascript:void(0)">
                    <img id="imgprview" class="profile-user-img img-responsive " src="{{isset($admin->image) ? url('/').'/images/driverdocs/'.$admin->image : url('/').'/images/users/no_image.png'}}" alt="User profile picture" style="height: 50px; width:50px;"  >
                  </a></td>
                  <td class="title"><a href="javascript:void(0)">{{$admin->first_name}}  {{$admin->last_name}}</a></td>
                  <td class="tablesaw-priority-3">{{$admin->email}}</td>
                  <td class="tablesaw-priority-3">{{$admin->phone}}</td>
                  <td class="tablesaw-priority-3">{{$admin->is_verified}}</td>
                  <td class="tablesaw-priority-3">{{$admin->created_at}}</td>
                  <td class="tablesaw-priority-3">{{$admin->is_active}}</td>
                  <td class="tablesaw-priority-3">
                    @if($admin->is_verified == 'No') 
                  ...
                  <td class="tablesaw-priority-2">
                     <a href="{{url('/')}}/delete-admin" class="__del" data-origin='{{$admin->_id}}'><i class="fa fa-times m-l-5 m-r-5"></i></a> 
                     <a href="{{url('/')}}/edit-driver/{{$admin->_id}}" class="edit-admin"><i class="fa fa-edit m-l-5 m-r-5"></i></a> 
                  </td>
                </tr>
              @endforeach
              </tbody>
