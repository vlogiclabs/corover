      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          {!! Form::open(['url' => 'edit-taxi-company']) !!}
           {!! Form::token() !!}

                 <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Company Name</label>
                  {!! Form::text('name',$admin->name,['class'=>'form-control','placeholder' => 'First Name']) !!}
                  {!! Form::hidden('id',$admin->_id,['class'=>'form-control','placeholder' => 'First Name']) !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Company Address</label>
                  {!! Form::textarea('address',$admin->address,['class'=>'form-control','placeholder' => 'Last Name']) !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Company Email Email</label>
                  {!! Form::text('email',$admin->email,['class'=>'form-control','placeholder' => 'Email']) !!}
                </div>

                <div class="form-group">
                  <label for="exampleInputFile">Company Phone Number</label>
                   {!! Form::text('phone',$admin->phone,['class' => 'form-control','placeholder' => 'Password']) !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Company Owner</label>
                   {{ Form::select('owner_id',$allusers, '$admin->ownder_id', ['class' => 'form-control']) }}
                </div>
