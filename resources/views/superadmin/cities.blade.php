        ...
        <!--PUT CONETNT HERE  -->
          <div class="col-lg-12 col-md-12">
            <table class="tablesaw table-striped table-hover table-bordered table tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="table-4226">
              <thead>
                <tr>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-priority="persist">City Name</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Country Name</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">City Code</th>
              ...
              @foreach($admins as $admin)
                <tr>
                  ...
                  <td class="tablesaw-priority-3">{{$admin->countrydata->name}}</td>
                  <td class="tablesaw-priority-3">{{$admin->code}}</td>
                  <td class="tablesaw-priority-2">
                     <a href="{{url('/')}}/delete-city" class="__del" data-origin='{{$admin->_id}}'><i class="fa fa-times m-l-5 m-r-5"></i></a> 
                     <a href="{{url('/')}}/edit-city/{{$admin->_id}}" class="edit-admin"><i class="fa fa-edit m-l-5 m-r-5"></i></a> 
                  </td>
                </tr>
              @endforeach
              </tbody>
