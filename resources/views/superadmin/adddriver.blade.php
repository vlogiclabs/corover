      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          {!! Form::open(['url' => 'add-driver','files' => true]) !!}
           {!! Form::token() !!}
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  {!! Form::text('dob',null,['class'=>'form-control datepicker','placeholder' => 'Date of Birth', 'autocomplete' => 'off']) !!}
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  {!! Form::text('phone',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
              <div class="col-md-4">
                  <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  {!! Form::textarea('address',null,['class'=>'form-control','placeholder' => 'Date of Birth', 'rows' => 4]) !!}
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group countryddwrapper" data-autogetcities="Yes" data-base="{{url('/')}}" >
                    <label for="exampleInputFile ">Country</label>
                       {!! Form::select('country_id',$countries,null,['class'=>'form-control countrydd']) !!}
                </div>
              </div>
               <div class="col-md-4">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('licence_no',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
               ...
               <div class="col-md-6">
                <div class="form-group">
                  ...
                  {!! Form::text('licence_expiry_date',null,['class'=>'form-control datepicker','placeholder' => 'Date of Birth', 'autocomplete' => 'off']) !!}
                </div>
              </div>
              </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('bank_account_name',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-group">
                  <label for="exampleInputFile">Bank Name *</label>
                  {!! Form::text('bank_name',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-group">
                  <label for="exampleInputFile">Bank Branch Name *</label>
                  {!! Form::text('bank_branch_name',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="exampleInputFile">Bank Branch Code *</label>
                  {!! Form::text('bank_branch_code',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-group">
                  <label for="exampleInputFile">Bank Account No*</label>
                  {!! Form::text('bank_account_no',null,['class'=>'form-control','placeholder' => 'Date of Birth']) !!}
                </div>
              </div>
