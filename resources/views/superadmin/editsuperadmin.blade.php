      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          {!! Form::open(['url' => 'edit-super-admin']) !!}
           {!! Form::token() !!}
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">First Name</label>
                  {!! Form::text('first_name',$admin->first_name,['class'=>'form-control','placeholder' => 'First Name']) !!}
                  {!! Form::hidden('_id',$admin->_id,['class'=>'form-control','placeholder' => 'First Name']) !!}
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Last Name</label>
                  {!! Form::text('last_name',$admin->last_name,['class'=>'form-control','placeholder' => 'Last Name']) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Role</label>
                  {{ Form::select('role', [ 1 => 'Super Admin' , 2 => 'Admin', 3 => 'User', 4 => 'Driver' ], $admin->role, ['class' => 'form-control']) }}
                </div>
