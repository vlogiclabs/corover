              ...
              @foreach($admins as $admin)
                <tr>
                  ...
                  <td class="tablesaw-priority-2">
                     <a href="{{url('/')}}/delete-super-admin" class="__del" data-origin='{{$admin->_id}}'><i class="fa fa-times m-l-5 m-r-5"></i></a> 
                     <a href="{{url('/')}}/edit-super-admin/{{$admin->_id}}" class="edit-admin"><i class="fa fa-edit m-l-5 m-r-5"></i></a> 
                  </td>
                </tr>
              @endforeach
              </tbody>
