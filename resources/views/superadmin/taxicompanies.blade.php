            ...
            <table class="tablesaw table-striped table-hover table-bordered table tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="table-4226">
              <thead>
                <tr>
                  ...
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Address</th>
                  ...
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Company Phone</th>
                  <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Company Owner</th>
              ...
              @foreach($admins as $admin)
                <tr>
                  ...
                  <td class="tablesaw-priority-3">{{$admin->address}}</td>
                  <td class="tablesaw-priority-3">{{$admin->email}}</td>
                  <td class="tablesaw-priority-3">{{$admin->phone}}</td>
                  <td class="tablesaw-priority-3">{{$admin->ownerdata->first_name}} {{$admin->ownerdata->last_name}}</td>
                  <td class="tablesaw-priority-2">
                     <a href="{{url('/')}}/delete-taxi-company" class="__del" data-origin='{{$admin->_id}}'><i class="fa fa-times m-l-5 m-r-5"></i></a> 
                     <a href="{{url('/')}}/edit-taxi-company/{{$admin->_id}}" class="edit-admin"><i class="fa fa-edit m-l-5 m-r-5"></i></a> 
                  </td>
                </tr>
              @endforeach
              </tbody>
